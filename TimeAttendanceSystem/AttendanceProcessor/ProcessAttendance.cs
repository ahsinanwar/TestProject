...
namespace TimeAttendanceSystem.AttendanceProcessor
{
    public class ProcessAttendance
    {
       ...
       private void CalculateTimeINOUT(AttData attendanceRecord, PollData up)
        ...
        public void CalculateShiftTimes(AttData attendanceRecord, Shift shift)
        {
            try
            {
                //Calculate WorkMin
        ...
        public void CalculateOpenShiftTimes(AttData attendanceRecord, Shift shift)
        {
            try
            {
                //Calculate WorkMin
        ...
        public void CalculateRosterTimes(AttData attendanceRecord, Roster roster, Shift shift)
        {
            try
            {
                TimeSpan mins = (TimeSpan)(attendanceRecord.TimeOut - attendanceRecord.TimeIn);
