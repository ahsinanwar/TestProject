                ...
                foreach (var item in _attEdit)
                {
                    ...
                    if (_TempAttData.TimeIn != null && _TempAttData.TimeOut != null)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                CalculateWorkMins.CalculateOpenShiftTimes(_TempAttData, _TempAttData.Emp.Shift, remarks);
                            }
                            else
                            {
                                //if (attendanceRecord.TimeIn.Value.Date.Day == attendanceRecord.TimeOut.Value.Date.Day)
                                //{
                                CalculateWorkMins.CalculateShiftTimes(_TempAttData, _TempAttData.Emp.Shift, remarks);
                                //}
                                //else
                                //{
